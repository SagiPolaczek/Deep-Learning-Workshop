...
if __name__ == "__main__":
    ...
    train_data_1 = pd.read_csv("./data/raw_data/higgs/training_part1.csv")
    train_data_2 = pd.read_csv("./data/raw_data/higgs/training_part2.csv")
    train_data_3 = pd.read_csv("./data/raw_data/higgs/training_part3.csv")

    train_data = pd.concat([train_data_1, train_data_2, train_data_3], axis=0, ignore_index=True)

    test_data = pd.read_csv("./data/raw_data/higgs/test.csv",)
    ...
    features_list_without_label = list(feature_selection(train_data, 25))
    ...
    train_data.to_csv("./data/raw_data/higgs/fs_training.csv", index=False)
    test_data.to_csv("./data/raw_data/higgs/fs_test.csv", index=False)
